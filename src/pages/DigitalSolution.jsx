        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', marginTop: '3rem' }}>
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              {['Website & landing pages', 'AI tools integration', 'E-commerce solutions', 'Business automation', 'IT support & consulting', 'Cloud solutions'].map((item) => (
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              {['Modern technology', 'Custom solutions', 'Competitive pricing', 'Quick deployment', 'Ongoing support', 'Scalable systems'].map((item) => (
                <li key={item} style={{ fontSize: '1rem', color: '#a08020', marginBottom: '1rem', paddingLeft: '1.5rem', position: 'relative' }}>
                  <span style={{ position: 'absolute', left: 0 }}>✓</span>
                  {item}
                </li>
