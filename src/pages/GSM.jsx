        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', marginTop: '3rem' }}>
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              {['Troubleshooting & diagnostics', 'System optimization', 'Privacy & security setup', 'Custom configurations', 'Performance tuning', 'User training'].map((item) => (
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              {['Expert technicians', 'Personalized approach', 'Competitive pricing', 'Fast turnaround', 'Local support', 'Warranty included'].map((item) => (
                <li key={item} style={{ fontSize: '1rem', color: '#a08020', marginBottom: '1rem', paddingLeft: '1.5rem', position: 'relative' }}>
                  <span style={{ position: 'absolute', left: 0 }}>✓</span>
                  {item}
                </li>
