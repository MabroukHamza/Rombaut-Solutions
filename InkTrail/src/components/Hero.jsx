...
function FlashDagger({ style }) {
  return (
    <svg
      viewBox="0 0 40 120"
      style={{ width: 24, opacity: 0.22, ...style }}
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        d="M20 4 L26 30 L24 90 L20 116 L16 90 L14 30 Z"
        stroke="var(--gold)"
        strokeWidth="1.5"
        fill="none"
      />
      ...
      <path
        d="M14 50 L8 44 L14 48 M26 50 L32 44 L26 48"
        stroke="var(--gold)"
        strokeWidth="1"
      />
    </svg>
...
function FlashRose({ style }) {
  return (
    <svg
      viewBox="0 0 80 80"
      style={{ width: 36, opacity: 0.2, ...style }}
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle
      ...
      />
      <path
        d="M40 14 Q48 22 40 32 Q32 22 40 14Z"
        stroke="var(--gold)"
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M22 32 Q30 24 40 32 Q30 40 22 32Z"
        stroke="var(--gold)"
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M58 32 Q50 24 40 32 Q50 40 58 32Z"
        stroke="var(--gold)"
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M40 50 Q48 42 40 32 Q32 42 40 50Z"
        stroke="var(--gold)"
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M38 50 Q36 58 34 72 M42 50 Q44 58 46 72"
        stroke="var(--gold)"
        strokeWidth="1"
      />
      <path
        d="M30 62 Q36 58 34 72 M50 62 Q44 58 46 72"
        stroke="var(--gold)"
        strokeWidth="0.8"
      />
    </svg>
...
function FlashEagle({ style }) {
  return (
    <svg
      viewBox="0 0 100 70"
      style={{ width: 52, opacity: 0.2, ...style }}
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        d="M50 10 Q60 20 70 18 Q80 16 88 22 Q76 24 68 30 Q72 38 68 44 Q60 36 50 40 Q40 36 32 44 Q28 38 32 30 Q24 24 12 22 Q20 16 30 18 Q40 20 50 10Z"
        stroke="var(--gold)"
        strokeWidth="1.2"
        fill="none"
      />
      <path
        d="M44 40 L42 56 L50 52 L58 56 L56 40"
        stroke="var(--gold)"
        strokeWidth="1"
        fill="none"
      />
...
function FlashSnake({ style }) {
  return (
    <svg
      viewBox="0 0 30 100"
      style={{ width: 18, opacity: 0.2, ...style }}
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        d="M15 8 Q22 18 15 28 Q8 38 15 48 Q22 58 15 68 Q8 78 15 88"
        stroke="var(--gold)"
        strokeWidth="1.5"
        fill="none"
        strokeLinecap="round"
      />
      <path
        d="M12 6 Q15 2 18 6 L16 12 L14 12 Z"
        fill="var(--gold)"
        opacity="0.5"
      />
      <path
        d="M13 88 L10 96 M17 88 L20 96"
        stroke="var(--gold)"
        strokeWidth="1"
      />
    </svg>
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse 60% 50% at 50% 45%, rgba(138,101,0,0.06) 0%, transparent 70%)",
        }}
      />
